...
import styles from '../Catalog/Catalogue.module.css';
...
const Catalogue = () => {
  ...
  return (
    <main className={styles.main}>
        <h3 className={styles.title}>POPULAR DECKS</h3>
              ...
              return (
                <div className={styles.card} key={details.id}>
                  <img src={details.image} alt="" />
                   <h5 className={styles.boardName}>{details.design}</h5>
                   <p className={styles.boardSize}>Size: {details.size}</p>
                   <h6 className={styles.boardPrice}>{details.price}</h6>
                  <button className={styles.addToCart} onClick={() => onOpenModal(details)}>
